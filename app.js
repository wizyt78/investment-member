...
const lang="en";
let theme=localStorage.getItem("ip_theme_v2")||"dark";
...
brandInvestment:"Investment",light:"Light",dark:"Dark",profilePicture:"Profile picture",choosePhoto:"Choose photo",logoutSuccess:"You have been signed out.",
...
$("refresh").onclick=async()=>{try{await load();toast("Account refreshed.")}catch(e){toast(e.message)}};
...
$("avatarFile").onchange=e=>{
 ...
 if(file.size>5*1024*1024){toast("Choose an image under 5MB.");e.target.value="";return}
